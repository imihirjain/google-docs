    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <button className={cn(
                    "h-7 shrink-0 flex flex-col items-center justify-center hover:bg-neutral-200/80 rounded-sm text-sm px-1.5 overflow-hidden"
                )}>
        ...
        <div className="flex items-center gap-x-0.5">
           ...
           </button>
           {
            isEditing?(
                ...
                className="h-7 w-10 text-sm border border-neutral-400 text-center bg-transparent cursor-text rounded-sm">
                    {currentFontSize}
                </button>
            )
           }
...
const ListButton = ()=>{
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <button className=
                    "h-7 min-w-7 shrink-0 flex flex-col items-center justify-center hover:bg-neutral-200/80 rounded-sm text-sm px-1.5 overflow-hidden"
                >
...
const ImageButton = ()=>{
    ...
    return (
        ...
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <button className="h-7 flex flex-col shrink-0 min-w-7 items-center justify-center rounded-sm hover:bg-neutral-200/80 text-sm px-1.5 overflow-hidden">
            ...
            <DropdownMenuContent>
                ...
                <DropdownMenuItem onClick={()=>setIsDialog(true)}>
...
export const Toolbar=()=>{
        ...
        [
            {
                ...
                onClick:()=> console.log("Console log to do")
            },
            {
                label:"List Todo",
                icon:ListTodoIcon,
    ...
    return (
        <div className="bg-[#f1f4f9] px-2.5 py-0.5 rounded-[24px] min-h-[40px] flex items-center overflow-x-auto gap-x-0.5">
        {
            sections[0].map((item)=>(
